  ...
  return (
    <main className="relative overflow-hidden bg-gradient-to-b from-blue-50 via-white to-white">
      ...
      <section className="mx-auto grid min-h-[88vh] w-full max-w-6xl grid-cols-1 items-center gap-10 px-6 py-14 lg:grid-cols-2">
        <RevealOnScroll className="lg:pr-6" delayMs={50}>
      ...
      <section className="mx-auto w-full max-w-6xl px-6 pb-16">
        ...
        <div className="space-y-10">
          <RevealOnScroll className="grid items-center gap-6 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200 md:grid-cols-2">
            ...
            <div className="rounded-xl bg-gradient-to-br from-blue-100 to-indigo-100 p-6">
              <div className="grid grid-cols-3 gap-2 text-xs font-semibold text-slate-700">
                <div className="rounded-lg bg-white p-3 text-center">TODO</div>
                <div className="rounded-lg bg-white p-3 text-center">
                  IN PROGRESS
                </div>
                <div className="rounded-lg bg-white p-3 text-center">DONE</div>
              </div>
            </div>
          </RevealOnScroll>

          <RevealOnScroll className="grid items-center gap-6 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200 md:grid-cols-2">
            <div className="order-2 rounded-xl bg-gradient-to-br from-emerald-100 to-cyan-100 p-6 md:order-1">
              <div className="grid grid-cols-3 gap-2 text-xs font-semibold text-slate-700">
                <div className="rounded-lg bg-white p-3 text-center">OWNER</div>
                <div className="rounded-lg bg-white p-3 text-center">
                  MANAGER
                </div>
                <div className="rounded-lg bg-white p-3 text-center">
          ...
          <RevealOnScroll className="grid items-center gap-6 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200 md:grid-cols-2">
            <div>
              ...
              <p className="mt-2 text-gray-600">
                Theo dõi đầy đủ lịch sử thay đổi task theo timeline để truy vết
                nhanh và làm việc minh bạch hơn.
              </p>
            </div>
            <div className="rounded-xl bg-gradient-to-br from-violet-100 to-fuchsia-100 p-6">
      ...
      <section className="mx-auto w-full max-w-6xl px-6 pb-20">
        <RevealOnScroll className="rounded-2xl bg-gradient-to-r from-blue-700 to-indigo-700 p-8 text-white shadow-lg">
